...
# Read the preamble from reportv2.typ
with open('reportv2.typ', 'r') as f:
    report2 = f.read()

# Extract preamble up to the TITLE PAGE comment
preamble = report2.split('// ═══════════════════════════════════════════════════════════════════════════\n//  TITLE PAGE')[0]
...
with open('reportv1.typ', 'w') as f:
    f.write(preamble + title_page + content)

print("reportv1.typ generated successfully.")
